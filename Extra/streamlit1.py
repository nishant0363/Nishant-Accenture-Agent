...
# Left column - Chat Box with fixed height
with left_col:
    ...
    if prompt := st.chat_input("What is up?"):
        ...
        with st.spinner("Thinking..."):
            response = agent.query(prompt)  # Replace with your actual function
...
# Right column - Notes.txt Content
with right_col:
    st.header("Reasoning")
    ...
    st.text_area("Notes Content", notes_content, height=350)
